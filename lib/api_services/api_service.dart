...
import '../customer_section/model/employee_model.dart';

class ApiService{

  //==================All Employee List=======================
  static fetchAllEmployee(
      // String? dateFrom, String? dateTo, String? customerId,
      // String? employeeId, String? productId, String? userFullName
      ) async {
  ...
  static fetchCustomerList(context, String? customerType) async {
    SharedPreferences? sharedPreferences;
    sharedPreferences = await SharedPreferences.getInstance();
    print("aaaaaaaaaaaaaaaaaaaaa$customerType,${sharedPreferences.getString("employee_id")}");
    try {
...
//==================District List=======================
  static fetchCustomerDue(String? customerId) async {
    ...
    try {
      ...
      var data = jsonDecode(response.data);
      print('CustomerDueModel List $data');
      return List.from(data).map((e) => CustomerDueModel.fromMap(e)).toList();
    } catch (e) {
      print(e);
    }
  ...
  context,
    ...
    try {
      ...
      print('GetSales dateFrom $dateFrom');
      print('GetSales dateTo $dateTo');
      print('GetSales employeeId ${sharedPreferences?.getString('employee_id')}');
      print('GetSales userFullName $userFullName');
      String url = "${baseUrl}api/v1/getSales";
      Response response = await Dio().post(url,
          data: {
  ...
  context,
    ...
    try {
      ...
      print('SalesRecord dateFrom $dateFrom');
      print('SalesRecord dateTo $dateTo');
      print('SalesRecord employeeId ${sharedPreferences?.getString('employee_id')}');
      print('SalesRecord userFullName $userFullName');
      String url = "${baseUrl}api/v1/getSalesRecord";
      Response response = await Dio().post(url,
          data: {
