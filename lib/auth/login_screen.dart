  ...
  fetchLogin() async {
    ...
    try {
      ...
      if (item["status"] == true) {
        ...
        sharedPreferences?.setString('employee_id', "${item["data"]["employeeId"]}",);
        ...
        print('sdagfasfasdf${sharedPreferences?.getString('employee_id')}');
        ...
        GetStorage().write("employeeId", "${item["data"]["employeeId"]}");
        ...
        print("employeeId : ${GetStorage().read("employeeId")}");
        print("image_name : ${GetStorage().read("image_name")}");
        print("branch : ${GetStorage().read("branch")}");
        print("branch_name : ${GetStorage().read("branch_name")}");
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          image: const DecorationImage(image: AssetImage("images/as2.png"),fit: BoxFit.fill,)
                      ),
                    ),
                    const SizedBox(
                      height: 20,
