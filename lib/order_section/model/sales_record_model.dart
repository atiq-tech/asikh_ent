...
class SalesRecordModel {
  ...
  final String saleMasterReturnTotal;
  final String saleMasterDamageTotal;
  ...
  SalesRecordModel({
    ...
    required this.saleMasterReturnTotal,
    required this.saleMasterDamageTotal,
  ...
  factory SalesRecordModel.fromMap(Map<String, dynamic> json) => SalesRecordModel(
    ...
    saleMasterReturnTotal: json["SaleMaster_ReturnTotal"]??"",
    saleMasterDamageTotal: json["SaleMaster_DamageTotal"]??"",
  ...
  Map<String, dynamic> toMap() => {
    ...
    "SaleMaster_ReturnTotal": saleMasterReturnTotal,
    "SaleMaster_DamageTotal": saleMasterDamageTotal,
