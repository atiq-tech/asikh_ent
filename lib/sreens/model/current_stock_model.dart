...
class CurrentStockModel {
  ...
  final String empwiseReturnQuantity;
  ...
  CurrentStockModel({
    ...
    required this.empwiseReturnQuantity,
  ...
  factory CurrentStockModel.fromMap(Map<String, dynamic> json) => CurrentStockModel(
    ...
    empwiseReturnQuantity: json["empwise_return_quantity"]??"",
  ...
  Map<String, dynamic> toMap() => {
    ...
    "empwise_return_quantity": empwiseReturnQuantity,
    "branch_id": branchId,
